...
public class OracleMyBatisSqlSessionFactory implements SqlSessionFactory {
	...
	@Override
	public SqlSession openSession(TransactionIsolationLevel transLevel1) {
		return sqlSessionFactory.openSession(transLevel1);
	}
	@Override
	...
	@Override
	public SqlSession openSession(ExecutorType exeType, TransactionIsolationLevel transLevel1) {
		return sqlSessionFactory.openSession(exeType, transLevel1);
	}
	@Override
