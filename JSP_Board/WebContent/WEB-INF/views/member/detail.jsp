	    	...
	    	<form role="form" class="form-horizontal"  method="post">
	        	<div class="register-card-body" >
	                ...
	                <div class="form-group row">
	                  ...
	                  <div class="col-sm-9">
	                  	<input name="id" type="text" class="form-control" id="inputEmail3" value="${member.name }" readonly>
	                  </div>
	                </div>
	                 <div class="form-group row">
	                  ...
	                  <div class="col-sm-9">
	                  	<input name="id" type="text" class="form-control" id="inputEmail3" value="${member.email }" readonly>
	                  </div>
	                </div>
	                 <div class="form-group row">
	                  <label for="inputPassword3" class="col-sm-3 control-label text-right">전화번호</label>
	                  <div class="col-sm-9">   
	                  	<input name="id" type="text" class="form-control" id="inputEmail3" value="${member.phone }" readonly>
	                  </div>                  
	                </div>               
	              </div>  
